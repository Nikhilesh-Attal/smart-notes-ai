  ...
  return (
    <div className="home-page-wrapper">
      ...
      <header className="home-header glass">
        ...
        </div> {/* Correctly closed div instead of </img> */}
        ...
        <div className="header-controls">
          ...
          <div className="header-auth">
            <div className="auth-toggle glass">
              <button className="auth-item" onClick={() => navigate("/login")}>Login </button>
              <button className="auth-item primary-pill" onClick={() => navigate("/signup")}> Signup </button></div>
</div>
        </div>
      </header>
